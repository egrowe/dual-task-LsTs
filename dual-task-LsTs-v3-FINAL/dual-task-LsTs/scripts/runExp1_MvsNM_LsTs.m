...
if cond == 2 || cond == 3
    ...
    if strcmp(TR(tr).picNoLeft, TR(tr).picNoRight)
...
%     if  strcmp(TR(tr).picNoLeft, TR(tr).picNoRight) && strcmp(TR(tr).angPeriphLeft(1),TR(tr).angPeriphRight(1))
%         trialTypePeriph = 'same';
%     end
%     
%     if (strcmp(TR(tr).picNoLeft, TR(tr).picNoRight) == 0) && (strcmp(TR(tr).angPeriphLeft(1),TR(tr).angPeriphRight(1)) == 0) %currently set to NOT EQUAL (not the pairings of furthest away degree rotation)
%         trialTypePeriph = 'different';
%     end
